...
export function ExportPlanner() {
  ...
  return (
    <div className="space-y-20 animate-in fade-in slide-in-from-bottom-4 duration-1000 relative pb-20">
      ...
      <div className="absolute top-0 right-0 -z-10 w-[600px] h-[600px] bg-emerald-500/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 -z-10 w-[400px] h-[400px] bg-maersk-blue/5 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2" />

      {/* Header Section */}
      <div className="relative pt-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-10">
          <div className="relative">
            <div className="absolute -left-12 top-1/2 -translate-y-1/2 w-2 h-24 bg-emerald-500 rounded-full shadow-[0_0_30px_rgba(16,185,129,0.6)]" />
            <motion.div
            ...
            >
              <h2 className="text-8xl font-black tracking-tighter text-maersk-dark drop-shadow-sm leading-[0.85] uppercase italic">
                Export<br />
                <span className="text-emerald-500 not-italic">Planner</span>
              </h2>
          ...
          >
            <div className="px-8 py-4 bg-white border border-slate-100 rounded-[2rem] shadow-2xl shadow-slate-200/50 flex items-center space-x-4 group hover:border-emerald-500/30 transition-all duration-500">
              <div className="relative">
      ...
      <div className="grid lg:grid-cols-12 gap-16 items-start">
        ...
        >
          ...
          <motion.div 
            ...
            className="mt-12 p-12 bg-emerald-950 rounded-[3.5rem] border border-white/10 flex flex-col space-y-8 shadow-[0_40px_80px_-20px_rgba(6,78,59,0.4)] relative overflow-hidden group"
          >
            ...
            <div className="p-5 bg-emerald-500/20 rounded-2xl w-fit border border-emerald-500/30 shadow-inner">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-6">
                <div className="p-5 bg-maersk-dark rounded-3xl shadow-2xl shadow-maersk-dark/30 ring-8 ring-slate-50 relative group overflow-hidden">
                  ...
                  <Calendar className="h-7 w-7 text-emerald-500 relative z-10" />
                </div>
                <div>
                  <h3 className="text-4xl font-black text-maersk-dark tracking-tighter uppercase italic">Network <span className="text-emerald-500 not-italic">Schedules</span></h3>
