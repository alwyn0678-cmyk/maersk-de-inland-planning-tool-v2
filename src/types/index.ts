...
export interface CYCYRequest {
  ...
  inlandTerminal?: string;      // Directly selected inland terminal/depot code (replaces zip lookup)
  zip?: string;                 // Legacy — kept for backward compat, no longer used in the form
